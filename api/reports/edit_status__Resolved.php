...
<body>
    <div class="wrapper">
        <h2 class="mt-5">Mark this report as 'Resolved'?</h2>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="alert alert-warning">
                <input type="hidden" name="id" value="<?php echo trim($_GET["id"]); ?>"/>
                <p>Once this report has been marked as resolved.</p>
                <p>It means the administrator has taken the inquiries of their requesting resident!</p>
                <p>
